# ============================================================
# ECON-1001 — Demand & Supply Demo (Homecooked)
#
# Purpose:
#   Build empirical demand and supply curves from student WTP/WTA
#
# Data:
...
homecooking <- homecooking %>%
  mutate(
    ...
    price =   pmax(0, price),  # to address negative prices
